...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor {
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation) {
        String nowParams = ""; if (request instanceof RepeatedlyRequestWrapper) {
        ...
        Object sessionObj = redisCache.getCacheObject(cacheRepeatKey); if (sessionObj != null) {
        ...
        } Map<String, Object> cacheMap = new HashMap<String, Object>(); cacheMap.put(url, nowDataMap);
        redisCache.setCacheObject(cacheRepeatKey, cacheMap, annotation.interval(), TimeUnit.MILLISECONDS); return false;
    }
