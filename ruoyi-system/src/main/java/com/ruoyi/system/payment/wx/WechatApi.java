...
import com.ruoyi.system.payment.util.HttpKit;
import com.ruoyi.system.payment.util.PayKit;
import com.ruoyi.system.payment.util.PaymentHttpResponse;
import com.ruoyi.system.payment.util.RequestMethodEnums;
...
public class WechatApi {
     ...
     * 获取接口请求的 URL
     *
     * @param wechatApi {@link com.ruoyi.system.payment.wx.enums.WechatApi} 支付 API 接口枚举
     * @return {@link String} 返回完整的接口请求URL
     */
    public static String getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi wechatApi) {
     ...
     * @return {@link String} 返回完整的接口请求URL
     */
    public static String getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi wechatApi, boolean isSandBox) {
     ...
     * @return {@link String} 返回完整的接口请求URL
     */
    public static String getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi wechatApi, WechatDomain wechatDomain, boolean isSandBox) {
        if (wechatDomain == null) {
            wechatDomain = WechatDomain.CHINA;
        }
        return wechatDomain.getType()
                .concat(isSandBox ? com.ruoyi.system.payment.wx.enums.WechatApi.SAND_BOX_NEW.getUrl() : "")
     ...
     *
     * @param apiUrl 接口 URL
     *               通过 {@link WechatApi#getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi)}
     *               或者 {@link WechatApi#getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi, WechatDomain, boolean)} 来获取
     * @param params 接口请求参数
     ...
     * @param urlSuffix    可通过 {@link com.ruoyi.system.payment.wx.enums.WechatApi} 来获取，URL挂载参数需要自行拼接
     * @param mchId        商户Id
    ...
    public static String sendWorkWxRedPack(Map<String, String> params, String certPath, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.SEND_WORK_WX_RED_PACK), params, certPath, certPass);
    }
    ...
    public static String sendWorkWxRedPack(Map<String, String> params, InputStream certFile, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.SEND_WORK_WX_RED_PACK), params, certFile, certPass);
    }
    ...
    public static String queryWorkWxRedPack(Map<String, String> params, String certPath, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.QUERY_WORK_WX_RED_PACK), params, certPath, certPass);
    }
    ...
    public static String queryWorkWxRedPack(Map<String, String> params, InputStream certFile, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.QUERY_WORK_WX_RED_PACK), params, certFile, certPass);
    }
    ...
    public static String trans2pocket(Map<String, String> params, String certPath, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.PAY_WWS_TRANS_2_POCKET), params, certPath, certPass);
    }
    ...
    public static String trans2pocket(Map<String, String> params, InputStream certFile, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.PAY_WWS_TRANS_2_POCKET), params, certFile, certPass);
    }
    ...
    public static String queryTrans2pocket(Map<String, String> params, String certPath, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.QUERY_WWS_TRANS_2_POCKET), params, certPath, certPass);
    }
    ...
    public static String queryTrans2pocket(Map<String, String> params, InputStream certFile, String certPass) {
        return execution(getReqUrl(com.ruoyi.system.payment.wx.enums.WechatApi.QUERY_WWS_TRANS_2_POCKET), params, certFile, certPass);
    }
