...
public class FileUploadUtils {
     ...
     *
     * @param bucketName minio 文件夹名称
     * @param file       上传的文件
     * @return 文件名称
     */
    public static String uploadMinio(String bucketName, MultipartFile file) {
        try {
    ...
    public static String getPicFileContentType(String fileType) {
        ...
        if (StrUtil.isNotBlank(fileType)) {
            switch (fileType) {
                ...
                case "jpe":
                case "jfif":
                    contentType = MimeTypeUtils.IMAGE_JPEG;
                    break;
                case "tiff":
                case "tif":
                    contentType = MimeTypeUtils.IMAGE_TIFF;
                    break;
                case "gif":
                    contentType = MimeTypeUtils.IMAGE_GIF;
                    break;
                case "png":
                    contentType = MimeTypeUtils.IMAGE_PNG;
                    break;
                case "ico":
                ...
                case "rp":
                    ...
                    break;
                case "bmp":
                    contentType = MimeTypeUtils.IMAGE_BMP;
                    break;
                default:
                    break;
            }
